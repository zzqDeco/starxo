...
- `settings.ssh.localNetwork.*` supports the macOS Local Network diagnostics card; copy must stay copy-only and must not imply Starxo can auto-change system privacy settings.
