...
## 核心职责
- 定义 macOS app bundle 元数据：固定 bundle identifier `com.starxo.app`、名称、版本、图标和最低系统版本。
...
## 维护要点
- 修改 bundle identifier 或版本字段时需要同步 release 打包验证和 `scripts/sign-darwin-app.sh` 的签名校验。
